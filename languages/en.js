const language = {
   ...
   msg14: "Queue has finished, add some more music! ✅",
   msg15: "I disconnected because there is no one left in the channel. ❌",
   ...
   msg32: "It's time to listen to music on your discord server with a completely free and advanced interface. Music bot that supports playing music on many platforms that will make your server feel special. Create your own music bot: https://github.com/lyahn/JeffX",
   msg33: "Bot Commands",
   ...
   msg101: `You can't have more than {max_music} tracks in a playlist. ❌`,
   msg102: "Loading track(s)... 🎧",
   msg103: "All tracks added to your playlist! 🎧",
   msg104: `This track is already in this playlist. ❌`,
   msg105: "added to the playlist! 🎧",
   msg106: `Write the name of the playlist you want to delete the music from. ❌`,
   msg107: `You don't already have a music with this name. ❌`,
   msg108: "Deleting music... 🎧",
   msg109: "Track deleted! 🎧",
   ...
   msg121: "<#{channel}> added to the command usage channel list, now bot commands can be used only on the channels in the list.",
   msg122: "There is no data already registered.",
   msg123: "<#{channel}> deleted from the command usage channel list.",
   msg124: "This channel is already on the command usage channel list.",
   msg125: "This channel is not a text channel.",
   msg126: "❌ Here is the list of channels you can use commands on this server: {channel_filter}",
